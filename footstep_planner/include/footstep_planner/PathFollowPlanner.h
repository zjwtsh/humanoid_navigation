...
#ifndef FOOTSTEP_PLANNER_PATHFOLLOWPLANNER_H_
#define FOOTSTEP_PLANNER_PATHFOLLOWPLANNER_H_
 ...
 * planner.
 */
class PathFollowPlanner: public FootstepPlanner
{
public:
  PathFollowPlanner();
  virtual ~PathFollowPlanner();
